        ...
        <Layout>
            ...
            <section className="pt-4">
                ...
                <section className="appointment-booking pt-5">
                    <span className="w-100 border-bottom pb-1 d-flex align-items-center justify-content-between">
                        <h3 className="fs-5">Appointment Booking</h3>
                        <a href="#add-new-appointment" className="h-100 btn btn-sm btn-outline-secondary py-0 border-radius-35 fw-semibold d-flex align-items-center">
                            <span className="mb-1">
